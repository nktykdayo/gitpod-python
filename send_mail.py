...
to_2=my_email_address.replace("@", "+1@")
...
to_emails = []
for address,name,color in zip(address_list,name_list,color_list):
    to = To(address,
        name=name,
...
sendgrid_client = SendGridAPIClient(os.environ.get("SENDGRIDx_API_KEY"))
